...
function _generateElectorPoolId() {
  const prefix = config['veres-one-validator'].environment === 'test' ?
    'did:v1:test' : 'did:v1';
  return `${prefix}:uuid:a3dd75aa-bb78-431d-b767-630831882545`;
}
