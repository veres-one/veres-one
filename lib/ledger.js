...
function _setupGenesisNode(callback) {
  async.auto({
    ...
    buildConfig: ['storeMaintainerDoc', 'storeGovernorsDoc',
      ...
      // FIXME: Enable validators
      /*
      ledgerConfig.ledgerConfigurationValidator.push({
        ...
        approvedSigner: [
          results.maintainerDoc.authentication[0].publicKey.id,
          results.governorsDoc.authentication[0].publicKey.id
        ],
