...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  // POST /accelerator/validations
  // Accelerates DID creation
  app.post(routes.accelerator + '/validations',
    // FIXME: enable auth
    ...
    accelerator.validations(req.body, (err, op) => {
      if(err) {
        return next(err);
      }
  ...
  docs.annotate.post(routes.accelerator + '/validations', {
